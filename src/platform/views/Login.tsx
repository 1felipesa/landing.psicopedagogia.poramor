...
const Login: React.FC = () => {
 ...
 <div className="w-full max-w-md bg-surface/80 backdrop-blur-xl rounded-[2.5rem] shadow-ambient overflow-hidden border border-white/50">
 ...
 <h1 className="text-2xl sm:text-3xl font-black text-on-surface tracking-tight font-display">Acesso VIP</h1>
 <p className="text-on-surface-variant mt-2 font-medium text-sm">Seu espaço seguro de acompanhamento e evolução.</p>
 </div>
 ...
 className="text-xs font-bold text-outline hover:text-[#5a2e8c] transition-colors"
 >
 Esqueci minha senha
 </button>
 </div>
