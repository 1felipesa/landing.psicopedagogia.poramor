...
const Register: React.FC = () => {
 ...
 <h1 className="text-2xl font-bold text-on-surface tracking-tight">Crie sua Conta</h1>
 <p className="text-on-surface-variant mt-2 font-medium">Junte-se à nossa comunidade</p>
 </div>
 ...
 className="font-bold text-primary hover:text-primary-700 hover:underline"
 >
 Faça Login
 </button>
 </p>
